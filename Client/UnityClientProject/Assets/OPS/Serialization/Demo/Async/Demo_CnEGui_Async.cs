...
public class Demo_CnEGui_Async : MonoBehaviour
{
    ...
    private IEnumerator SaveAsync(Teacher teacher)
    {
        ...
        UnityEngine.Debug.Log("Saved Teacher: " + teacher.Name);
    }
    ...
    private void OnSavedAsync_Alternative(object myObject, byte[] bytes)
    {
        ...
        UnityEngine.Debug.Log("Saved Teacher: " + ((Teacher)myObject).Name);
    }
    ...
    private IEnumerator LoadAsync()
    {
        ...
        UnityEngine.Debug.Log("Loaded Teacher: " + teacher.Name);
    }
