...
public class Demo_CnEGui : MonoBehaviour
{
    public void Save()
    {
        ...
        UnityEngine.Debug.Log("Save Teacher: " + teacher.Name + " ElapsedMilliseconds: " + stopwatch.ElapsedMilliseconds);
    }
    ...
    public void Load()
    {
        ...
        UnityEngine.Debug.Log("Load Teacher: " + teacher.Name + " ElapsedMilliseconds: " + stopwatch.ElapsedMilliseconds);
    }
}
